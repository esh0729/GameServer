...
{
	//=====================================================================================================================
	// SFHandler를 상속받은 작업 핸들러의 객체 생성을 위한 요청 타입과 핸들러 클래스 타입을 저장하는 추상 클래스
	//=====================================================================================================================
	public abstract class SFHandlerFactory
	{
		...
		// 클라이언트 요청 타입을 키로 하여 핸들러 클래스 타입을 저장하는 컬렉션
		...
		{
			// 클라이언트 요청 타입과 일반화된 핸들러 클래스 타입을 저장
			m_handlers.Add(nName, typeof(T));
		}

		//=====================================================================================================================
		// 핸들러 타입을 호출하는 함수
		// Return : 클라이언트 요청 타입에 매칭 되는 핸들러 클래스 타입
		//
		// nName : 클라이언트 요청 타입
		//=====================================================================================================================
